  ...
  grunt.registerMultiTask('connect', 'Start a connect web server.', function() {
    ...
    async.waterfall([
      ...
      function(){
        ...
        app.use(connect.query()) // gives us req.query
        app.use(connect.bodyParser())  // gives us req.body
        app.use(connect.cookieParser()) // for session
        app.use(connect.session({ secret: "asdf" }))     // gives us req.session
