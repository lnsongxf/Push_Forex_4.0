function StartAlgoAle()
    ...
    % SETTING TOPICS PUB
    fileIdPub = fopen('configPublishersAle.txt');
    ...
    fileIdSub = fopen('configListenersAle.txt');
    ...
    while 1
            ...
            if isMember == 1
                ...
                [topicPub, messagePub]=onlineAlgoAle(topicName,messageBody);
