function [topicPub,messagePub,startingOperation]=onlineOpenLore(oper,openValue,stopLoss,takeProfit,indexOpen)
...
magic=strcat('magic=',num2str(720));                                       % magic number, algo id.
