function StartAlgo004(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers004.txt');
...
fileIdSub = fopen('configListeners004.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo004_client03(topicName,messageBody,password);
