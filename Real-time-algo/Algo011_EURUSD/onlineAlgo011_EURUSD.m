function [topicPub,messagePub] = onlineAlgo011_EURUSD(topicSub,messageSub,password)
...
listener3 = strcmp(topicSub,'STATUS@EURUSD@1110');
...
elseif listener3 && ( strcmp(ms.machineStatus,'closing') || strcmp(ms.machineStatus,'opening') )%new status
    ...
    elseif close
        ...
        elseif StatusClose == -1 || price < 0
            ...
            if trial < 5
                trial=trial+1;
                [topicPub,messagePub,startingOperation]=onlineClose011_EURUSD(lastCloseValue,ticket,indexClose);
...
if abs(updatedOperation) > 0 && startingOperation == 0
    ...
    [topicPub,messagePub,startingOperation]=onlineOpen011_EURUSD(oper,openValue,MT4stopL,MT4takeP,indexOpen);
...
elseif updatedOperation == 0 && abs(startingOperation) > 0
    % Closing request
    [topicPub,messagePub,startingOperation]=onlineClose011_EURUSD(closeValue,ticket,indexClose);
