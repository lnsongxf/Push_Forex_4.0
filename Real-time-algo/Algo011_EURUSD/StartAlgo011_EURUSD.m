function StartAlgo011_EURUSD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers011_EURUSD.txt');
...
fileIdSub = fopen('configListeners011_EURUSD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo011_EURUSD(topicName,messageBody,password);
