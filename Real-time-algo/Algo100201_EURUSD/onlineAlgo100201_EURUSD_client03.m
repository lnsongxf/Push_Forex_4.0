function [topicPub,messagePub] = onlineAlgo100201_EURUSD_client03(topicSub,messageSub,password)
...
nameAlgo          = 'Algo100201_EURUSD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@EURUSD@100201';
algoMagic         = 100201;
nData             = 100;
operLots          = 1;
...
listener3 = strcmp(topicSub,'STATUS@EURUSD@100201');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && (ms.statusNotification == 0) )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo100201_leadlag_EURUSD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
