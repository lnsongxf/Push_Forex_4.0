function StartAlgo100200(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers100200.txt');
...
fileIdSub = fopen('configListeners100200.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo100200_client03(topicName,messageBody,password);
