function StartAlgo100200_EURUSD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers100200_EURUSD.txt');
...
fileIdSub = fopen('configListeners100200_EURUSD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo100200_EURUSD_client03(topicName,messageBody,password);
