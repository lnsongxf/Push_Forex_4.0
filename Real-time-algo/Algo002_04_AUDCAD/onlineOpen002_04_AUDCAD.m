function [topicPub,messagePub,startingOperation]=onlineOpen002_04_AUDCAD(oper,openValue,stopLoss,takeProfit,indexOpen)
...
magic=strcat('magic=',num2str(1204));                                      % magic number, algo id.
sl=strcat('sl=',num2str(stopLoss));                                        % not madatory
tp=strcat('tp=',num2str(takeProfit));                                      % not mandatory
topicPub='OPERATIONS@ACTIVTRADES@AUDCAD@1204';
