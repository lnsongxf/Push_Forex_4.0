function StartAlgo101100_AUDCAD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers101100_AUDCAD.txt');
...
fileIdSub = fopen('configListeners101100_AUDCAD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo101100_AUDCAD_client03(topicName,messageBody,password);
