function [topicPub,messagePub] = onlineAlgo100502_EURUSD_client03(topicSub,messageSub,password)
...
nameAlgo          = 'Algo100502_EURUSD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@EURUSD@100502';
algoMagic         = 100502;
nData             = 100;
operLots          = 1;
...
listener1 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m50@v100');
listener2 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m1@v1');
listener3 = strcmp(topicSub,'STATUS@EURUSD@100502');
...
%     time30 = tic;        % used for measuring the time spent for parsing
    ...
    LogObj.info('MATLAB info','new data array at 50min received');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && (ms.statusNotification == 0) )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo100502_inverted_macd_EURUSD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
