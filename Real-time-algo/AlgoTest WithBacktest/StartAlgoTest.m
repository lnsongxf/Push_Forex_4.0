function StartAlgoTest(varargin)

userArg1 = varargin{1};
userArg2 = varargin{2};
display(strcat('var1: ', 1));
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishersTest.txt');
...
fileIdSub = fopen('configListenersTest.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgoTest_client03(topicName,messageBody,password);
