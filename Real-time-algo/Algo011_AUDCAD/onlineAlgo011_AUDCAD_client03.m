function [topicPub,messagePub] = onlineAlgo011_AUDCAD_client03(topicSub,messageSub,password)
...
nameAlgo          = 'Algo011_AUDCAD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@AUDCAD@1011';
algoMagic         = 1011;
nData             = 100;
operLots          = 1;
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && ms.statusNotification == 0 )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo_011_stocOsc_AUDCAD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
