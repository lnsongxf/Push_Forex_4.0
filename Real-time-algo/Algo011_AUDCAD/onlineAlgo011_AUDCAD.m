function [topicPub,messagePub] = onlineAlgo011_AUDCAD(topicSub,messageSub,password)
...
listener3 = strcmp(topicSub,'STATUS@EURUSD@1111');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && ms.statusNotification == 0 )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo_011_stocOsc_AUDCAD(matrix,newTimeScalePoint,openValueReal,timeSeriesProperties,timeMin);
