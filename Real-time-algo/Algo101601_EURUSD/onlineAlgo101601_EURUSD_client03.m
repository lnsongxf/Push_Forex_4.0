function [topicPub,messagePub] = onlineAlgo101601_EURUSD_client03(topicSub,messageSub,password)
...
nameAlgo          = 'Algo101601_EURUSD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@EURUSD@101601';
algoMagic         = 101601;
nData             = 100;
operLots          = 1;
...
listener1 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m60@v100');
listener2 = strcmp(topicSub,'TIMEFRAMEQUOTE@MT4@ACTIVTRADES@EURUSD@m1@v1');
listener3 = strcmp(topicSub,'STATUS@EURUSD@101601');
