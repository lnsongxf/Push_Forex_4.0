function [topicPub,messagePub] = onlineAlgo100804_EURUSD_client03(topicSub,messageSub,password)
...
nameAlgo          = 'Algo100804_EURUSD';
algoTopicPub      = 'OPERATIONS@ACTIVTRADES@EURUSD@100804';
algoMagic         = 100804;
nData             = 100;
operLots          = 1;
...
listener3 = strcmp(topicSub,'STATUS@EURUSD@100804');
...
if ( ( strcmp(ms.machineStatus,'closed') || strcmp(ms.machineStatus,'open') ) && (ms.statusNotification == 0) )
    t=now;
    timeMin=t*60*24;
    [oper,openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo100804_invertedSupertrend_EURUSD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,timeMin);
