function StartAlgo100804_EURUSD(IP,password)
...
% SETTING TOPICS PUB
fileIdPub = fopen('configPublishers100804_EURUSD.txt');
...
fileIdSub = fopen('configListeners100804_EURUSD.txt');
...
while 1
    ...
    if isMember == 1
        ...
        [topicPub, messagePub]=onlineAlgo100804_EURUSD_client03(topicName,messageBody,password);
