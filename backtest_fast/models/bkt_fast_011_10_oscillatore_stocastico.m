classdef bkt_fast_011_10_oscillatore_stocastico < handle
    ...
    methods
        ...
        function obj = spin(obj, Pminute, matrixNewHisData, ~, newTimeScale, kperiods, ~, cost, ~, ~, wTP, wSL, plottami)
...
%                         display(['Pminute =', num2str(Pminute(j))]);
                        ...
                        [TakeProfitPrice,StopLossPrice,TakeP,StopL,~] = closingDiffexpert(Pbuy,Pminute(j),segnoOperazione,TakeP,StopL, 0, dynamicParameters);
