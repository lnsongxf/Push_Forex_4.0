classdef bkt_fast_016_double_repo_debug < handle
                ...
                if (trigger1 == 0)
                    ...
                    if ( s(i) == s(i-1) )
                        ...
                        if (trendLenght == 1) % record the price when the trend starts
                            ...
                            display(['starTrendPrice=' num2str(starTrendPrice), ', i=',num2str(i)]);
                        end
                        ...
                        elseif (trendLenght >= 8 && abs(P(i-1)-starTrendPrice)<= 50 )
                             display(['1a penetrazione non riuscita xe deltaP=', num2str(abs(P(i-1)-starTrendPrice)) ,'<=50 i=' num2str(i)]);
                             trendLenght = 0;
                            trigger1 = 0;
