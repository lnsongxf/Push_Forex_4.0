function [oper, openValue, closeValue, stopLoss, noLoose, minReturn] = Algo100200_leadlag(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,indexHisData)
