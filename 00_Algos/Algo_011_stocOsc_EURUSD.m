function [oper, openValue, closeValue, stopLoss, takeProfit, minReturn] = Algo_011_stocOsc_EURUSD(matrix,newTimeScalePoint,openValueReal,timeSeriesProperties,indexHisData)
