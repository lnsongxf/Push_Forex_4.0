...
if(isempty(countCycle) || countCycle == 0)
    ...
    params = Parameters;
    map('Algo_100205') = RealAlgo(operationState,params);
    oper = 0;
    return;
end
...
if newTimeScalePoint
    ...
    % 01c
    % -------- coreState filter -------------------- %
    cState.core_Algo_002_leadlag(chiusure(1:end-1),params,45,8,4,7,50);
