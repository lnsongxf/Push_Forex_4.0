function [oper, openValue, closeValue, stopLoss, noLoose, minReturn] = Algo101900_residual_EURUSD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,indexHisData)
...
st               = stationarity;
TimeSeriesExpert = TimeSeriesExpert_11;
...
if(isempty(countCycle) || countCycle == 0)
    ...
    params = Parameters;
    map('Algo101900') = RealAlgo(operationState,params);
    oper = 0;
    return;
end
