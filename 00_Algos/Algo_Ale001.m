function [oper, openValue, closeValue, stopLoss, noLoose, valueTp, real] = Algo_Ale001(matrix)
...
if(isempty(countCycle) || countCycle == 0)
    ...
    params         = Parameters;
    map('Algo_Ale001') = RealAlgo(operationState,params);
    oper = 0;
    real = 0;
    return;
end
