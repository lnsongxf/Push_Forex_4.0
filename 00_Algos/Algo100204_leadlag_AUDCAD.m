function [oper, openValue, closeValue, stopLoss, noLoose, minReturn] = Algo100204_leadlag_AUDCAD(matrix,newTimeScalePoint,newTimeScalePointEnd,openValueReal,timeSeriesProperties,indexHisData)
