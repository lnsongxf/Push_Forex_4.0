classdef TimeSeriesExpert7_2 < handle
    ...
    methods
        ...
        %%
        function [obj]=MultidimBinary(obj,data)
        ...
        function [obj]=maxMinSearch(obj,closure,type,rate,t0s,i,x1,yEnd_f1) %#ok<INUSL>
        ...
        function [obj]=linFitTrendRec(obj,data,actTimeScale,newTimeScale,n,fun,inFit)
            ...
            % inFit=[0 0];
            % [type,rate,err,indexStart,i]=expert.linFitTrendRec(data(1:5000,:),1,10,1,@linear1,inFit)
            %
            ...
            while tf==0
                ...
                %                 obj.startTrend=t0s(indexStart,1);
                %                 obj.rateTrend=rate(indexStart,1);
                ...
                %                 display(obj.rateTrend);
                %                 display(obj.typeTrend);
                %                 display(obj.qFitTrend);
                %                 display(obj.qUpTrend);
                %                 display(obj.qDwTrend);
        ...
        function [q0,res,rate,type] = linearRegression (obj,closure)
