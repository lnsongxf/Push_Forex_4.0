classdef TimeSeriesExpert2 < handle
    ...
    methods
        ...
        function [obj]=maxMinSearch(obj,type,rate,t0s,i)
...
%              obj.aveRB=mean(rebound);
        ...
        function [type,rate,err,indexStart,i]=linFitTrendRec(obj,actTimeScale,n,fun,inFit)
            ...
            while tf==0
                ...
                x2=(t02:s:i*s)';
                ct2=c(t02:s:i*s);
                [vEnd_f2, yEnd_f2, err2] = fit(n,x2,ct2,fun,inFit2);
                err(i,2)=err2;
                ...
                if i>t01+2;
                    %display(rate);
                    [obj]=maxMinSearch(obj,type(in,1),rate(in,1),t0s,i);
