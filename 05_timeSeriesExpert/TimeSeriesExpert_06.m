classdef TimeSeriesExpert6 < handle
    ...
    methods
        ...
        function plotBinary(obj,data,lengthData)
            ...
            figure(100);
            plot(l,dataClosure(1:lengthData),'-b');
            hold on
        ...
        %%
        function [type,rate,err,indexStart,i]=linFitTrendRec(obj,data,actTimeScale,n,fun,inFit)
            ...
            while tf==0
                ...
                x2=(t02:s:i*s)';
                ct2=c(t02:s:i*s);
                [vEnd_f2, yEnd_f2, err2] = fit1(n,x2,ct2,fun,inFit2);
                err(i,2)=err2;
                ...
                q0Micro(inMicro,1)=vEnd_f2(1,2);
                rate(inMicro,2)=abs(vEnd_f2(1,1));
                type(inMicro,2)=sign(vEnd_f2(1,1));
                inFit2=[type(inMicro,2).*rate(inMicro,2);vEnd_f2(1,2)];
                ...
                [indexStartMicro,~,~]=find(t0sMicro(:,1)~=0);
                ...
                obj.startMicroTrend=t0sMicro(indexStartMicro,1);
                obj.rateMicroTrend=rate(indexStartMicro,2);
                obj.typeMicroTrend=type(indexStartMicro,2);
                
                display(obj.startMicroTrend);
                display(obj.rateMicroTrend);
                display(obj.typeMicroTrend);
