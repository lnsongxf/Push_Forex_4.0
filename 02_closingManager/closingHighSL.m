function [TakeProfitPrice,StopLossPrice,newTakeP,newStopL,dynamicOn] = closingHighSL(OpenPrice,LastClosePrice,direction,TakeP,StopL, ~, dynamicParameters)
...
% some values according to the dynamicParameters (lateSL is usually very high)
% ---------------------------------------------------
