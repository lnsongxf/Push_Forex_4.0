function vout = tech_indicators(vin,mode,varargin)
...
% Syntax
%     Momentum
%         cci                  = tech_indicators([hi,lo,cl]      ,'cci'    ,tp_per,md_per,const)
%         roc                  = tech_indicators(price           ,'roc'    ,period)
%         rsi                  = tech_indicators(price           ,'rsi'    ,period)
%         [fpctk,fpctd]        = tech_indicators([hi,lo,cl]      ,'fsto'   ,k,d)
%         [spctk,spctd]        = tech_indicators([hi,lo,cl]      ,'ssto'   ,k,d)
%         [fpctk,fpctd,jline]  = tech_indicators([hi,lo,cl]      ,'kdj'    ,k,d)
%         willr                = tech_indicators([hi,lo,cl]      ,'william',period)
%         [dn,up,os]           = tech_indicators([hi,lo]         ,'aroon'  ,period)
%         tsi                  = tech_indicators(cl              ,'tsi'    ,r,s)
%     Trend
%         sma                  = tech_indicators(price           ,'sma'    ,period)
%         ema                  = tech_indicators(price           ,'ema'    ,period)
%         [macd,signal,macdh]  = tech_indicators(cl              ,'macd'   ,short,long,signal)
%         [pdi,mdi,adx]        = tech_indicators([hi,lo,cl]      ,'adx'    ,period)
%         t3                   = tech_indicators(price           ,'t3'     ,period,volfact)
%     Volume
%         obv                  = tech_indicators([cl,vo]         ,'obv')
%         cmf                  = tech_indicators([hi,lo,cl,vo]   ,'cmf'    ,period)
%         force                = tech_indicators([cl,vo]         ,'force'  ,period)
%         mfi                  = tech_indicators([hi,lo,cl,vo]   ,'mfi'    ,period)
%     Volatility
%         [middle,upper,lower] = tech_indicators(price           ,'boll'   ,period,weight,nstd)
%         [middle,upper,lower] = tech_indicators([hi,lo,cl]      ,'keltner',emaper,atrmul,atrper)
%         atr                  = tech_indicators([hi,lo,cl]      ,'atr'    ,period)
%         vr                   = tech_indicators([hi,lo,cl]      ,'vr'     ,period)
%         hhll                 = tech_indicators([hi,lo]         ,'hhll'   ,period)
%     Other
%         [index,value]        = tech_indicators(price           ,'zigzag' ,moveper)
%         change               = tech_indicators(price           ,'compare')
%         [pivot sprt res]     = tech_indicators([dt,op,hi,lo,cl],'pivot'  ,type)
%         sar                  = tech_indicators([hi,lo]         ,'sar'    ,step,maximum)
% 
% Arguments
%     Outputs
...
% Example
%     load disney.mat
%     vout = tech_indicators([dis_HIGH,dis_LOW,dis_CLOSE],'fsto',14,3);
%     fpctk = vout(:,1);
%     fpctd = vout(:,2);
